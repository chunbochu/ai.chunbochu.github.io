...
You have free access to these books with your Franklin student credentials.

 - AI: Poole, D. L., & Mackworth, A. K. (2023). Artificial Intelligence: Foundations of Computational Agents (3rd ed.). Cambridge: Cambridge University Press. 13 August 2023. ISBN: 9781009258227 https://artint.info/index.html

 - KG: Barrasa, J., & Webber, J. (2023). Building knowledge graphs: A practitioner's guide. O'Reilly.  https://learning.oreilly.com/library/view/building-knowledge-graphs/9781098127091/

 - GDL: Foster, D. (2023). Generative deep learning: Teaching machines to paint, write, compose, and play (2nd ed.). O'Reilly Media. https://learning.oreilly.com/library/view/generative-deep-learning/9781098134174/

 - GA: Wirsansky, E. (2024). Hands-on genetic algorithms with Python: Apply genetic algorithms to solve real-world AI and machine learning problems (2nd ed.). Packt Publishing. https://learning.oreilly.com/library/view/hands-on-genetic-algorithms/9781805123798/
...
| **3** | **Game and Adversarial Search** | [AI](https://artint.info/index.html): 14.1, 14.2, 14.3, 14.7.3<br>[Monte-Carlo Tree Search](https://dke.maastrichtuniversity.nl/m.winands/documents/Encyclopedia_MCTS.pdf)<br>LlamaIndex: [RAG Pipeline](https://developers.llamaindex.ai/python/framework/understanding/rag/) (Loading, Nodes, Connectors) |
...
| **7** | **Artificial Neural Networks** | [AI](https://artint.info/index.html): 8.1 to 8.3<br>LlamaIndex: [Building a Chatbot](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/chatbots/building_a_chatbot/)<br>*Optional:* [Interactive Gradient Descent Demo](https://blog.skz.dev/gradient-descent) |
